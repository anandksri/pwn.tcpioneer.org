...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#09090B] pt-36 pb-8">
      {/* Background */}
      ...
      <Container>
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-9 text-zinc-400">
            ...
            hands-on labs, real-world projects, and expert-curated resources.
            Learn step by step, practice your skills, and grow into a confident
